...
if __name__== "__main__":
    key = "AAAAkdP3f44:APA91bEyls0NapnpJi9IZvMe7jEpkYYDx99bdCcFUYtIy4ZDEsEaKaZd1DRhodK6yIXiiWvRfwCE_17HU2uz04s--1qYSw635BgB_ilMxwlQEbBPOqoJkFTPpWnERbbJ2401Eyh27Szyv"
    push_service = FCMAPI(api_key=key)

    registration_id = ["eSUQAef0S2Y:APA91bHm_Q2YJnzBJI77g7mTADW1teFd3i0t8gOM8HqJuv2RgO3_FFSI03ffShGCXus6jNNyILZ3Xng2jNKQdMCJ5FBPneJifkhQ9RJsC52reHfoXOxeEQvLFRbXZw1mKccUIGjf7P7_l"]
    message_title = "Test"
    message_body = "Hi RASHAD, your customized news for today is ready"
